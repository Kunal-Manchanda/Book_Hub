...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        drawerLayout.addDrawerListener(actionBarDrawerToggle)//adding a click listener on the hamburger icon,i.e,actionBarDrawerToggle

        actionBarDrawerToggle.syncState()//change the hamburger icon to back arrow icon and vice-versa
